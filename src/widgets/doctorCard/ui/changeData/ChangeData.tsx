...
import {
    ICityItemDoctor,
    ICooperationTypeDoctor,
    ISpecialityItemDoctor,
    useDoctorActions
...
export const ChangeData: FC<IProps> = ({cities, specialities, cooperations}) => {
    ...
    const {
        ...
        setInstUrl, setTiktokUrl, setDzenUrl, setSiteLink, setMainBlogTheme,
        setMarketingPreferences, setMainCity, setMainSpeciality, setCooperationType, setBirthDate
    } = useDoctorActions()
    ...
    return (
        <section className={classes.main}>
            ...
            <InputEdit sign="Ссылка на ЮТУБ" value={doctor.youtubeUrl} setValue={setYoutubeUrl}/>
            ...
            <InputEdit sign="Дата рождения" value={doctor.birthDate} setValue={setBirthDate}/>
            <InputEdit
